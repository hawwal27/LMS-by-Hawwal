  ...
  return courseData ? (  
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        text-course-details-heading-small font-semiold text-gray-800'>{courseData.courseTitle}</h1>
        {/* <p>{courseData.courseDescription}</p> */}
        <p className='pt-4 md:text-baes text-sm'
        ...
        {/* review and rating */}
         ...
         <div className='flex item-center space-x-2 pb-1 text-sm'>
                ...
                <div className='pt-8 text-gray-800'>
                  <h2 className='text-xl font-semiold'>Course Structure</h2>
                    ...
                    {courseData.courseContent.map((chapter, index)=>(
                      ...
                      rounded'>
                        ...
                        px-4 py-3 cursor-pointer select-none' onClick={()=> toggleSection(index)}>
                          ...
                          <p className='text-sm md:text-default'>{chapter.
                          chapterContent.length} lectures - {calculateChapterTime(chapter)}</p>
                        ...
                        border-t border-gray-300 '>
                          {chapter.chapterContent.map((lecture, i)=> (
                            <li key={i} className='flex items-start gap-2 py-1'>
                              <img src={assets.play_icon} alt="play_icon" className='w-4  g-4 mt-1' />
        ...
        md:pt-4 text-gray-500'>
          ...
          <div className='pt-6'>
            ...
            text-gray-500'>
              ...
              <li>Downlaodable resources and source code.</li>
