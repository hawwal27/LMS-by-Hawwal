...
const CallToAction = () => {
  return (
    ...
    px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>All made his loved love not have shades most what memory. Call sing power resolved knew parasites sighed muse hope. Some alas taste had her this. Nor not rake he.</p>
